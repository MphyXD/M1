...
def banner():
 prints(panel(f"""{H2}                                   
 DAFA-XD
 DUNIA RECODE ADALAH DUNIA BERKAH 
""",style=f"white"))
###-----[ LOGIN COOKIES V1 ]-----###
ses = requests.Session()
def awalan():
...
def ugen():
  ...
  asep0 = random.choice(["Y6MLQN","8G7LN3","2783VM","X35XFL","W5T30Y"])
  asep1 = f"Dalvik/2.1.0 (Linux; U; Android 10; itel W6004 Build/QP1A.190711.020)"
  asep2 = f"Mozilla/5.0 (Linux; Android 9; SAMSUNG SM-J701M Build/PPR1.180610.011) AppleWebKit/537.36 (KHTML, like Gecko) SamsungBrowser/9.0 Chrome/67.0.3396.87 Mobile Safari/537.36"
  asep3 = f"Mozilla/5.0 (Linux; Android 9; SAMSUNG SM-A705FN) AppleWebKit/537.36 (KHTML, like Gecko) SamsungBrowser/17.0 Chrome/96.0.4664.104 Mobile Safari/537.36"
  asep4 = f"Mozilla/5.0 (Linux; Android 7.0; SAMSUNG SM-G920A) AppleWebKit/537.36 (KHTML, like Gecko) SamsungBrowser/20.0 Chrome/106.0.5249.126 Mobile Safari/537.36"
  return rc([asep1])
